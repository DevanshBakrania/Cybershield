...
class MainActivity: FlutterFragmentActivity() {
  ...
  private fun getGpuFullInfo(): Map<String, Any> {
    ...
    try {
        ...
        map["renderer"] = renderer ?: "Unknown"
        map["vendor"] = vendor ?: "Unknown"
        map["openglVersion"] = version ?: "Unknown"
        map["extensions"] = extensions ?: "Unknown"

    } catch (e: Exception) {

        map["renderer"] = "Unknown"
        map["vendor"] = "Unknown"
        map["openglVersion"] = "Unknown"
        map["extensions"] = "Unknown"
    }
    ...
    try {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 24) {
            ...
            map["vulkanSupported"] = hasVulkan

        }

    } catch (e: Exception) {

        map["vulkanSupported"] = false
    }
